...
plotpow <- ggplot(data = df, aes(x=n.diff,y=averagepower, color = design)) + geom_point() + ylab("Average Power") + 
  xlab("Deviation from planned sample size") + scale_colour_manual(name="Design", values = c("Olson and Koyama" = "skyblue2",
                                                                                             "Chang et al."     = "dodgerblue3",
