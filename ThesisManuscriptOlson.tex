...
\begin{equation}
\begin{aligned}
\mbox{P(Weak}_{t,p}) \sum_{x=s_1+1}^{n_1} b(x, n_1, p) - B(s_1 - x, n - n_1, p)
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\mbox{PET}_0 = \mbox{P(Strong}_{1,p_0})
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\mbox{EN}_0 = n_1 + \mbox{P(Weak}_{1,p_0})\times (n_t - n_1)
\end{aligned}
\end{equation}
...
\begin{figure}[]
\caption{Monte Carlo Simulation of Average Power and Type I error of 20 Simon-like Designs when Stage I Sample Size Deviates from Planned for Attained Designs ($n_t^{\ast\ast} = n_1^{\ast\ast} + n_2$). Number of Simulations = 10000.}
\centering
\begin{Schunk}
...
\end{figure}
\begin{figure}[]
\caption{Monte Carlo Simulation of Average Power of 20 Simon-like Designs when Stage I Sample Size Deviates from Planned for Attained Designs ($n_t^{\ast\ast} = n_1^{\ast\ast} + n_2$) Number of Simulations = 10000.}
\centering
\begin{Schunk}
...
\begin{figure}[]
\caption{Monte Carlo Simulation of Average Power of 20 Simon-like Designs when Stage I Sample Size Deviates from Planned for Attained Designs ($n_t^{\ast\ast} = n_t$) Number of Simulations = 10000.}
\begin{Schunk}
...
\begin{figure}[]
\caption{Monte Carlo Simulation of Average Type I Error Rates of 20 Simon-like Designs when Stage I Sample Size Deviates from Planned for Attained Designs ($n_t^{\ast\ast} = n_t$) Number of Simulations = 10000.}
\begin{Schunk}
